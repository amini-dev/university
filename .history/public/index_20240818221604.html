...
<head>
    ...
    <title>Amini University</title>
    <link rel="stylesheet" href="css/dependencies/fontAwesome.css">
    <link rel="stylesheet" href="css/dependencies/swiper-bundle.min.css">
    <link rel="stylesheet" href="css/fonts.css">
    <link rel="stylesheet" href="css/app.css">
    <link rel="stylesheet" href="css/custom.css">
</head>

<body class="font-irYekan"">
        ...
        <div class="pointer-events-auto relative w-screen">
            ...
            <div class="flex h-full flex-col overflow-y-scroll bg-white py-4 dark:bg-dark-800 dark:text-slate-400">
                <div class="flex justify-between items-center px-4 ">
                    <img class="bg-white h-12" src="images/logo-dark.png" alt="">
    ...
    <header class="fixed top-0 z-20 w-full">
        <div class="container mt-2">
            <div
                ...
                <div>
                    <img src="images/logo-dark.png" alt="logo" class="w-12 bg-white">
                </div>
                ...
                <div class="flex gap-4 items-center">
                    ...
                    <div class="hidden md:block relative" x-data="{lang: false}">
                        <span x-on:click="lang = !lang"
                            class="bg-slate-200 py-3 space-x-4 px-3 pl-7 text-xs rounded-xl"> فارسی - fa </span>
                    ...
                    <div class="swiper head-slider rounded-xl h-full">
                        ...
                        <div class="swiper-wrapper max-h-64 md:max-h-[480px]">
                            ...
                            <div class="swiper-slide">
                                <img src="images/001.jpg" alt="" class="w-full h-64 md:h-[480px]">
                            </div>
                            <div class="swiper-slide">
                                <img src="images/002.jpg" alt="" class="w-full h-64 md:h-[480px]">
                            </div>
                            <div class="swiper-slide">
                                <img src="images/003.jpg" alt="" class="w-full h-64 md:h-[480px]">
                            </div>
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="p-4 shadow-primary rounded-2xl dark:bg-dark-800">
                                    <div class="relative">
                                        <a href="#">
                                            <img src="images/announcement/004.jpg" alt=""
                            ...
                            <div class="swiper-slide">
                                <div class="p-4 shadow-primary rounded-2xl dark:bg-dark-800">
                                    <div class="relative">
                                        <a href="#">
                                            <img src="images/announcement/003.jpg" alt=""
                                                class="w-full h-[180px] rounded-xl">
                                        </a>
                                        <div
                                            class="flex flex-col items-center w-fit shadow-lg p-3 gap-2 bg-white text-sm rounded-xl absolute left-5 -bottom-1/4">
                            ...
                            <div class="swiper-slide">
                                <div class="p-4 shadow-primary rounded-2xl dark:bg-dark-800">
                                    <div class="relative">
                                        <a href="#">
                                            <img src="images/announcement/005.jpg" alt=""
                                                class="w-full h-[180px] rounded-xl">
                                        </a>
                                        <div
                                            class="flex flex-col items-center w-fit shadow-lg p-3 gap-2 bg-white text-sm rounded-xl absolute left-5 -bottom-1/4">
                            ...
                            <div class="swiper-slide">
                                <div class="p-4 shadow-primary rounded-2xl dark:bg-dark-800">
                                    <div class="relative">
                                        <a href="#">
                                            <img src="images/announcement/001.jpg" alt=""
                                                class="w-full h-[180px] rounded-xl">
                                        </a>
                                        <div
                                            class="flex flex-col items-center w-fit shadow-lg p-3 gap-2 bg-white text-sm rounded-xl absolute left-5 -bottom-1/4">
                                            ...
                                            <div class="w-full p-4">
                                                <a href="#"
                                                    class="inline-block h-48 overflow-hidden rounded-xl shadow-lg"><img
                                                        ...
                                                        src="images/education-group/architect-400x300.jpg.webp"
                                                        alt=""></a>
                                            </div>
                                            <div class="px-4 pb-4">
                                                <h3>
                                        ...
                                        <div
                                            ...
                                            <div class="w-full p-4">
                                                <a href="#"
                                                    class="inline-block h-48 overflow-hidden rounded-xl shadow-lg"><img
                                                        class="w-full h-full transform transition duration-300 hover:scale-110"
                                                        src="images/education-group/islamic-history-400x300.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="px-4 pb-4">
                                                <h3>
                                        ...
                                        <div
                                            ...
                                            <div class="w-full p-4">
                                                <a href="#"
                                                    class="inline-block h-48 overflow-hidden rounded-xl shadow-lg"><img
                                                        class="w-full h-full transform transition duration-300 hover:scale-110"
                                                        src="images/education-group/civilengineer-400x300.webp"
                                                        alt=""></a>
                                            </div>
                                            <div class="px-4 pb-4">
                                                <h3>
        ...
        <div class="container">
            <div class="relative">
                ...
                <div class="flex items-center justify-between sm:flex-row flex-col relative z-10">
                    <div class="w-fit bg-white dark:bg-dark-850 sm:mb-0 mb-6 pl-8 pr-8 sm:pr-0">
                        <img class="h-16 dark:bg-white" src="images/logo-dark.png" alt="">
                    </div>
                        ...
                        <li class="flex items-center justify-between mb-7 last:mb-0 dark:text-slate-400">
                            <span class="flex items-center">
                                <span class="relative ml-3">
                                    ...
                                    <svg class="dark:text-blue-300 text-blue-980 absolute -top-1 -left-2" width="17"
                            ...
                            <a class="dark:text-white text-slate-600 dark:hover:text-blue-450 font-medium text-sm transition transform duration-200 ease-linear hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:ml-2"
                                href="mailto:r.amini3977@gmail.com">r.amini3977@gmail.com</a>
                        </li>
                            ...
                            <span class="flex items-center">
                                <span class="relative ml-3">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor"
                                        class="dark:text-blue-300 text-blue-980 absolute -top-1 -left-2"
                                        viewBox="0 0 17 17">
                                        <path
            ...
            <div>
                <div
                    ...
                    <span>
                        کلیه حقوق مادی و معنوی سایت برای دانشگاه شهید امینی محفوظ است.
                    </span>
                    <span>
                        ساخته شده با ❤️ توسط روح الله امینی
                    </span>
                </div>
            </div>
        </div>
    ...
    <script src="js/dependencies/alpinejs.min.js" defer></script>
    <script src="js/dependencies/swiper-bundle.min.js" defer></script>
