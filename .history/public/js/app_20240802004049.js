...
const themeSwitcher = document.getElementsByClassName(".mobile__theme-switcher");
...
const mobile_sidebar_close_btn = document.querySelector("#mobile__sidebar__close-btn");
